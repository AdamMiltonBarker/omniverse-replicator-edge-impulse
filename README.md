...
![NVIDIA Omniverse™ Synthetic Data Generation For Edge Impulse Projects](assets/img/omniverse-edge-impulse.jpg)
...
![Synthetic Data](assets/img/synthetic-data.jpg)
...
![NVIDIA Omniverse™](assets/img/omniverse.jpg)
...
![NVIDIA Omniverse™](assets/img/nvidia-omniverse-enterprise-diagram.jpg)
...
![Edge Impulse](assets/img/edge-impulse.jpg)
...
![On-Device Testing Results](assets/img/edge-impulse-omniverse.gif "On-Device Testing Results")
...
![GPU Requirements](assets/img/gpu-requirements.jpg)
...
![NVIDIA Omniverse™ Launcher](assets/img/omniverse-launcher.jpg)
...
![NVIDIA Omniverse™ Code](assets/img/omniverse-code.jpg)

We are going to use [Omniverse™ Code](https://developer.nvidia.com/omniverse/code-app) to create our dataset.

![Omniverse™ Code](assets/img/omniverse-code-extension.jpg) 
...
### Script Editor
![Script Editor](assets/img/script-editor.jpg)
...
For simplicity, in this tutorial we will use assets that are readily available in Omniverse™ Code. With the IDE you will find a tab called `NVIDIA Assets`, opening this tab will provide you with a selection of ready to use assets. The assets are of type `USD` which stands for `Universal Scene Description`.
...
![Generate Data](assets/img/generate-data.jpg)
...
![Generated Data](assets/img/generated-data.jpg)
...
Next we will visualize our dataset, including the bounding boxes that were generated by the writer. In Visual Studio Code, open the project root and open the `visualize.py` file. Once it is open open the terminal by clicking `view` -> `Terminal`.

Next install the required software. In terminal enter the following commands:
...
![Connect device](assets/img/connect-device.jpg "Connect device")
...
![Device connected to Edge Impulse](assets/img/device-connected.jpg "Device connected to Edge Impulse")

Once complete head over to the devices tab of your project and you should see the connected device.

## Upload Data

![Upload Data](assets/img/upload-data.jpg "Upload Data")
...
![Labelling Data](assets/img/labelling-data.jpg "Labelling Data")

Next head over to the `Labelling Queue` page. Here you can draw around your data and add labels to each fruit in each image, then repeat these steps for each of the classes.
...
![Completed Data](assets/img/completed-dataset.jpg "Completed Data")
...
![Create Impulse](assets/img/create-impulse.jpg "CCreate Impulse")
...
![Parameters & Features](assets/img/generate-features.jpg "Parameters & Features")
...
![Training](assets/img/training.jpg "Training")
...
![Training Results](assets/img/training-results.jpg "Training Results")
